<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?= base_url() ?>performance/store_sales/<?= $store['store_id'] ?>">
				<?= $store['store'] ?></a></li>
	</ol>
</section>
<br>
			...
			<div class="box-body">
				<div class="row">
					<div class="col-xs-12">
                        ...
                        if(!empty($food_chart)){
                        ?>
						<canvas id="food_sales_chart" width="400" height="100"></canvas>
						<?php
                        }
                        ?>
					</div>
						...
						<table id="data-table" class="table table-bordered table-hover data-table">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td><a target="_blank" href="<?= base_url() ?>sales/details/<?= $row['sales_id'] ?>"><?= $row['total'] ?></a></td>
...
<script>
	var food_sales_chart = document.getElementById("food_sales_chart");
	var sales_chart = document.getElementById("sales_chart");

	var food_sales_chart = new Chart(food_sales_chart, {
		type: "pie",
		data: {
			labels: [
				<?php
