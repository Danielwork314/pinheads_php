<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li>
			<a href="<?= base_url() ?>customize/add"> Add Customize</a>
		</li>
	</ol>
</section>
<br>
<section class="content">
	...
	<div class="box box-primary">
		...
		<!-- /.box-header -->
		<!-- form start -->
		<form role="form" class="input_form" method="POST" action="<?= base_url()?>customize/add" enctype="multipart/form-data">
			<div class="box-body">
				<?php 
				if (isset($error)) { 
					?>
				...
				<div class="form-group">
					<div class="col-md-9 dressing_menu">
						...
						<div class="form_food">
						<select class="form-control select2" required id="dressing_id">
...
<script>
	...
	$('.submit_btn').click(function(){
		...
		$.ajax({
			url:'<?=base_url()?>Customize/add',
			type: "POST",
			data: postParam,
			success:function(data)
			{
				console.log(data);
				window.location = "<?= base_url() ?>Customize";
			}, 
			error: function () {
				console.log("error");
			}
